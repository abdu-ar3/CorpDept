<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow navbar-static-top navbar-light navbar-brand-center">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <!-- <li class="nav-item"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="creaative admin logo" src="app-assets/images/logo/prasetia 2.png">
                        <h4 class="brand-text">Prasetia</h4>
                    </a></li> -->
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                                    ...
                                    <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-heading info">Coming Soon</h6>
                                ...
                                <div class="arrow_box_right">
                                    ...
                                    <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-heading text-bold-700">Windy A<i class="ft-circle font-small-2 success float-right"></i></h6>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-heading text-bold-700">Abdu Web Dev<i class="ft-circle font-small-2 danger float-right"></i></h6>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-heading text-bold-700">JUuuu<i class="ft-circle font-small-2 warning float-right"></i></h6>
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"> <span class="avatar avatar-online"><img src="{{asset('app-assets/images/icons/user.png')}}" alt="avatar"></span></a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><span class="user-name text-bold-700 ml-1">  @if(\Auth::user())
                                {{Auth::user()->name}}
                                @endif
                             </span></span></a>
