...
@section('title') Admin Edit HC Reveneu @endsection
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Edit HighChart Reveneu</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Admin HighChart Reveneu Edit
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form
                                        ...
                                        action="{{ route('hcrev.update', $hcRev->id) }}"
                                        method="POST"
                                    >
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="number" name="value" class="form-control"  value="{{ $hcRev->value }}"  required>
                                        </div>
