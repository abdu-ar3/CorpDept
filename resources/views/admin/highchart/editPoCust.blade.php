...
@section('title') Admin Edit HC PO CUST @endsection
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Edit HighChart PO CUST</h3>
                </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form
                                        ...
                                        action="{{ route('hcpo.continue', $hcPo->id) }}"
                                        method="POST"
                                    >
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="nameCust" class="form-control"  value="{{ $hcPo->cust }}"  required>
                                        </div>
