        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Edit Reveneu</h3>
                </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form
                                        ...
                                        action="{{ route('corp.update', $corpRev->id) }}"
                                        method="POST"
                                    >
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="period_id" id="period_id" class="form-control">
                                                ...
                                                @foreach($period as $per)
                                                    <option value="{{ $per->id }}" @if ($corpRev->period_id == $per->id) selected @endif>{{ $per->month_year }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="number" name="value" class="form-control"  value="{{ $corpRev->value }}"  required>
                                        </div>
