            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">SUMMARY 2024</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">History Month Corporate 2024</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Revenue 2024</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Purchase Order 2024</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    @php
                                                        ...
                                                        foreach ($type_job as $tj) {
                                                            foreach ($tj->po_achiev as $po) {
                                                               // Cek apakah pdash_id lebih dari 12
                                                                if ($po->pdash_id > 12) {
                                                                    $grandTotal += $po->value;
                                                                }
                                                            }
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                    ...
                                                    <td>
                                                    <a href="https://docs.google.com/spreadsheets/d/1bmd0AkGF0V-KrZOP5yNxgcK7R1JoCMkY/edit?usp=sharing&ouid=110546107101493557324&rtpof=true&sd=true" class="btn btn-danger btn-sm"> Excel Link</a>
                                                    <a href="{{ route('grafik.ponew') }}" class="btn btn-success btn-sm"> Grafik</a>
                                                    </td>
                                            </tr>
                                            @endforeach
